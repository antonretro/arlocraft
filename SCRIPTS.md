...
| File | Purpose |
|------|---------|
| `utils/assetUrl.js` | Resolves asset paths for both dev (Vite) and production builds |
| `utils/SkinLoader.js` | Fetches Minecraft-style player skins from Minotar and maps to Three.js materials |
