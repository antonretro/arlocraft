...
- `public/icons/items/glitch_saber.png`
- `public/icons/items/static_bow.png`
- `public/icons/items/data_drill.png`
- `public/icons/items/decoder_wand.png`
- `public/icons/items/magnet_glove.png`
...
- `public/icons/items/sand.png`
- `public/icons/items/wood.png`
- `public/icons/items/leaves.png`
- `public/icons/items/glass.png`
- `public/icons/items/water.png`
- `public/icons/items/virus.png`
...
- `src/assets/arlo_eye.svg` (can be replaced with PNG + code update)
