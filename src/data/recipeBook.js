...
export const RECIPE_BOOK = [
  ...
  },
  {
    ...
    pattern: ['III', 'I I'],
    key: { I: 'iron' },
    result: { id: 'iron_helmet', count: 1, kind: 'armor' },
  },
  {
    id: 'iron_chestplate',
    ...
    pattern: ['I I', 'III', 'III'],
    key: { I: 'iron' },
    result: { id: 'iron_chestplate', count: 1, kind: 'armor' },
  },
  {
    id: 'iron_leggings',
    name: 'Iron Leggings',
    ...
    pattern: ['III', 'I I', 'I I'],
    key: { I: 'iron' },
    result: { id: 'iron_leggings', count: 1, kind: 'armor' },
  },
  {
    id: 'iron_boots',
    name: 'Iron Boots',
    ...
    pattern: ['I I', 'I I'],
    key: { I: 'iron' },
    result: { id: 'iron_boots', count: 1, kind: 'armor' },
  },
  {
    id: 'oak_door',
    name: 'Oak Door',
    ...
    pattern: ['WW', 'WW', 'WW'],
    key: { W: 'oak_planks' },
    result: { id: 'oak_planks_door', count: 3, kind: 'block' },
  },
  {
    id: 'oak_trapdoor',
    name: 'Oak Trapdoor',
    ...
    pattern: ['WWW', 'WWW'],
    key: { W: 'oak_planks' },
    result: { id: 'oak_planks_trapdoor', count: 2, kind: 'block' },
  },
];
