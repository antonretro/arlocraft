...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    icon: '🪵',
    check: (stats) =>
      stats.blocksMined.has('oak_log') ||
      stats.blocksMined.has('birch_log') ||
      stats.blocksMined.has('spruce_log'),
  },
  {
    id: 'stone_age',
    name: 'Stone Age',
    ...
    icon: '🪨',
    check: (stats) =>
      stats.blocksMined.has('stone') || stats.blocksMined.has('cobblestone'),
  },
  {
    id: 'collector',
