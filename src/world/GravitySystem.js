...
export class GravitySystem {
    constructor(world) {
        ...
        this.fallableIds = new Set(['sand', 'gravel', 'red_sand', 'concrete_powder', 'anvil']);
    }
    ...
    canFallThrough(id) {
        if (!id || id === 'air' || id === 'water' || id === 'fire' || id === 'virus') return true;
    ...
    triggerFall(x, y, z, id) {
        ...
        let targetY = y - 1;
        while (targetY > 0 && this.canFallThrough(this.world.getBlockAt(x, targetY - 1, z))) {
            targetY--;
        }
