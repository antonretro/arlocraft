...
export const village_hut = {
    ...
    blueprints: (ox, oy, oz) => {
        ...
        const h3 = Math.abs(Math.sin((ox + 73) * 17.1 + (oz - 31) * 91.7) * 43758.5453) % 1;

        // --- Footprint: 5x5, 6x5, or 7x6 ---
        const footprintSizes = [[5, 5], [6, 5], [7, 6]];
        ...
        const wallMats = ['oak_planks', 'birch_planks', 'stone_bricks', 'sandstone', 'spruce_planks'];
        ...
        blocks.push({ x: ox + Math.floor(W / 2), y: oy + wallH - 1, z: oz + Math.floor(D / 2), id: 'glowstone' });
