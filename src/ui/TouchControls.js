...
export class TouchControls {
  ...
  _bindEvents() {
    ...
    document.addEventListener('touchstart', (e) => this._onStart(e), {
      passive: false,
    });
    ...
    document.addEventListener('touchcancel', (e) => this._onEnd(e), {
      passive: false,
    });
  ...
  _applyJoy() {
    ...
    if (dy < -DEAD) keys['KeyW'] = true;
    else delete keys['KeyW'];
    if (dy > DEAD) keys['KeyS'] = true;
    else delete keys['KeyS'];
    if (dx < -DEAD) keys['KeyA'] = true;
    else delete keys['KeyA'];
    if (dx > DEAD) keys['KeyD'] = true;
    else delete keys['KeyD'];
  }
