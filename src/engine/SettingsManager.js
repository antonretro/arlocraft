    ...
    load() {
        ...
        try {
            ...
            return {
                ...
                qualityTierPref: ['low', 'balanced', 'high'].includes(parsed.qualityTierPref)
                ...
                selectedWorldSlot: typeof parsed.selectedWorldSlot === 'string'
                    ? parsed.selectedWorldSlot
                    : defaults.selectedWorldSlot,
                shadowsEnabled: parsed.shadowsEnabled !== undefined
                ...
                perfPanelVisible: parsed.perfPanelVisible !== undefined
