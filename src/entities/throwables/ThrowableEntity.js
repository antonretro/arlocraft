...
export class ThrowableEntity {
    ...
    checkCollisions(delta) {
        const moveDir = new THREE.Vector3().subVectors(this.position, this.lastPosition);
        ...
        const worldHit = this.game.world.interaction.raycastBlocks(this.lastPosition, normalizedDir, distance);
        if (worldHit) {
        ...
        }, distance, (e) => e !== this.owner && !e.dead);
